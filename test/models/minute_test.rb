...
=end
	...
	test " blocks other employees for this status for given minute and subsequent minutes -- " do 
	...
	test " adds reports to existing order -- " do 


	end


	test " removes reports from existing order -- " do 
	...
	test " adds tubes to bookings -- " do 
		...
		## how do we pick the tubes
		## we already know which tubes have been added.
